...
| `dwd_千川_素材m` | 千川素材分钟拼接数据 | SQL建模 | ODS |
| `dwd_千川_素材h` | 千川视频小时聚合数据关联千川财务数据 | SQL建模 | ODS |
| `dwd_抖店_宽表` | 抖店订单+售后+结算数据 | SQL建模 | ODS |
| `dwd_红书_宽表` | 小红书订单+售后+结算数据 | SQL建模 | ODS |
| `dwd_微信_宽表` | 微信小店订单+售后+结算数据 | SQL建模 | ODS |
